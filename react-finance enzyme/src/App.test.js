...
describe("passing props", () => {
  ...
  it("contains savingBalance value", () => {
    ...
    const expecedValue = userBalance.savingBalance + "$";
    expect(value).toEqual(expecedValue);
  });
...
describe("logic", () => {
  ...
  it("button click - update balance", () => {
    ...
    const expectBalanceValue = userBalance.balance - 100 + "$";
    expect(balanceValue).toEqual(expectBalanceValue);
  });
});
